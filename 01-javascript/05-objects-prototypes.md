...
## Summary: Object Creation Patterns

| Pattern | Syntax | Pros | Cons |
|---------|--------|------|------|
| Object Literal | `{}` | Simple, fast | No shared behavior |
| Constructor | `new Func()` | Traditional, initialization | Complex, 'new' required |
| Object.create() | `Object.create(proto)` | Explicit prototype, flexible | No initialization |
| Class | `new Class()` | Modern syntax, familiar | Still prototypal underneath |
| Factory | `factory()` | No 'new', flexible | More memory (no shared prototype) |
